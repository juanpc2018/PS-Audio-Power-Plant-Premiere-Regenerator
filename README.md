...
The PS Audio PPP has CleanWave, a Degauser Wave, is high frequency Sine wave injected </br>
to main 60Hz sine. </br>
...
PS Audio converts 120 AC from the Wall to DC, and back to 120vAC </br>
using DDS, DA converter, generates a flawless AC signal. </br>
but that is "too pure" for most equipments, thats why MultiWave was invented. </br>
